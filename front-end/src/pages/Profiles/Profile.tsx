      ...
      <main id="profile-content">
        <form onSubmit={(e) => handlerNewPassword(e)}>
          <div className="principal">
            <span>Nome:</span>
            <input placeholder={ControleSessao.getUserName()} disabled/>
            <span>Email:</span>
            <input type="text" placeholder={ControleSessao.getUserEmail()} disabled/>
            <span>Setor:</span>
            <input placeholder={ControleSessao.getUserSetor()} disabled/>
            <span>Cargo:</span>
            <input type="text" placeholder={ControleSessao.getUserCargo()} disabled/>
            ...
            <input
              type="password"
              placeholder="Digite novamente a sua senha nova"
