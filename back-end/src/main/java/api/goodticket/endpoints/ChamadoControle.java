...
public class ChamadoControle {
	...
	public ResponseEntity<?> inserirSolucao(@RequestBody SolucaoDTO solucao) {
		...
		if (chamadoSelecionado != null) {
			if (chamadoSelecionado.getSolucao() == null && usuarioSelecionado.getCargos().get(0).equals(Cargo.ROLE_SUPPORT)
					&& usuarioSelecionado.getCredencial().getEmail().equals(chamadoSelecionado.getSuporte().getEmail()) && solucao.getBody() != null) {
	...
	public ResponseEntity<?> inserirComentario(@RequestBody ComentarioDTO comentario){
		...
		if (chamadoSelecionado != null && (comentario.getEmail().equals(chamadoSelecionado.getSuporte().getEmail()) ||
				comentario.getEmail().equals(chamadoSelecionado.getRelator().getEmail())) && comentario.getBody() != null) {
